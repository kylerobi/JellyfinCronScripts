...
1. **changeName.sh**
  ...
  - This is inspired from the legend that first discovered the changes you can make in Jellyfin, [BobHasNoSoul](https://github.com/BobHasNoSoul)
2.  **MediaBar_MakD.sh**
  ...
  - [IAmParadox27 - MediaBar Plugin](https://github.com/IAmParadox27/jellyfin-plugin-media-bar)
  - [MakD - MediaBar](https://github.com/MakD/Jellyfin-Media-Bar)
